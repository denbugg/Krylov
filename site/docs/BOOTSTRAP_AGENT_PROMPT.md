...
First read, in order:
1. `site/AGENTS.md`
2. `site/docs/PRODUCT.md`
3. `site/docs/DESIGN.md`
4. `site/docs/SEO_GEO.md`
5. `site/docs/INFRASTRUCTURE.md`
6. `site/docs/DEPLOYMENT.md`
7. `site/docs/SECURITY.md`
...
Before deployment, confirm that the current visual payload has been imported into `site/templates/` and `site/static/`. If it is missing, ask the user to attach/import `elite_site_payload.tar.gz` with SHA-256 `4d5b1be172126f4cc7bc280688d4a2fada36dea19314fd098a83cf85b199f5c7`, extract it into `site/`, review the diff, and commit it to `sitest` before continuing.
